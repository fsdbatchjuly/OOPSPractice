	...
	public static void main(String[] args) {
		...
		Car ford = new Car();
		 ...
		 Tyre frontLeftTyre = new Tyre("Black", 30, 20, 20, 5000, "Alloy Wheels", "Front Left Tyre");
			...
			Mirror frontleftmirror = new Mirror( "concave", "white", 50, 30, 20," brass");
			Mirror   frontrightmirror= new Mirror( "concave", "white", 50, 30, 20," brass");
			Mirror   backleftmirror =  new Mirror( "concave", "white", 50, 30, 20," brass");
		    Mirror    backrightmirror = new Mirror( "concave", "white", 50, 30, 20," brass");
	 ...
	 ford. frontRightTyre.startMoving();
		...
		ford. frontleftmirror = frontleftmirror;
			ford.  frontrightmirror = frontrightmirror;
			ford.backleftmirror =   backleftmirror;
		    ford.backrightmirror =   backrightmirror;
		    
		    ford.backleftmirror .mirrorOpen();
			ford.frontleftmirror.mirrorOpen();
			ford.backrightmirror.mirrorClose();
	        ford .frontrightmirror.mirrorClose();
